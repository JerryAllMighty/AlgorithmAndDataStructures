...
public class Main {
    public static void main(String[] args) {
        ...
        int n = input[0];
        int m = input[1];
        int[] lstA = new int[2500000];
        int[] lstB = new int[2500000];
        ...
        Arrays.fill(lstA, previousTimeA + 1, 2500000, previousIdxA);
        ...
        Arrays.fill(lstB, previousTimeB + 1, 2500000, previousIdxB);
